...
public class WebSpa {
    ...
    protected static final String[] ALLOWED_FIRST_PARAM = {"-help", "-client", "-server", "-version", "-start", "-stop", "-status", "-checker"};
    ...
    public int processParameters(final String[] args) {
        ...
        if (args.length > 0) {
            ...
            if (args[0].equalsIgnoreCase(ALLOWED_FIRST_PARAM[0])) {
                ...
                mode = 6;
            } else if (args[0].equalsIgnoreCase(ALLOWED_FIRST_PARAM[7])) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (mode) {
            ...
            case 6:
                ...
                break;
            case 7:
                LOGGER.info("Welcome - Running the WebSpa Checker");
                myGestalt = new WSChecker(mySpa);
                myGestalt.runConsole();
                break;
            default:
